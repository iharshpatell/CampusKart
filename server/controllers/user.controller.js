...
export async function registerUserController(req, res) {
  try {
    ...
    // 2. Normalize email (avoid case-sensitive duplicates)
    ...
    // During development/testing, send all emails to verified email
    const emailRecipient = process.env.NODE_ENV === 'development' 
      ? VERIFIED_TEST_EMAIL 
      :  savedUser.email;
